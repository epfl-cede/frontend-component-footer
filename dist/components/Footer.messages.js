...
var messages = defineMessages({
  ...
  'footer.openlearnitylogo.altText': {
    id: 'footer.openlearnitylogo.altText',
    defaultMessage: 'Runs on OpenLearnity',
    description: 'alt text for the footer openlearnity logo'
  },
  ...
  'footer.copyright.text': {
    ...
    defaultMessage: "Copyrights \xA9".concat(new Date().getFullYear(), ". All Rights Reserved."),
